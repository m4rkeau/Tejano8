<!DOCTYPE html>
    <head lang="en">
        ...
        <title>Super Admin Site Images</title>
...
<body>
  ...
  <a href="SA_Si.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25)); margin-left:12px; margin-top:-10px;" class="w3-bar-item w3-button"><u><b>SITE IMAGES</u></b></a>
