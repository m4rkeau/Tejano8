...
<hr>
  ...
  <a href="SA_Staff.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25));margin-left:12px;margin-top:-10px;" class="w3-bar-item w3-button"><u><b>STAFF</u></b></a>
  ...
  <div>
              <table class="table">
                  ...
                  <tbody>
                      ...
                      $query = "SELECT id, username, email, password FROM staff";
