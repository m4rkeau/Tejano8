<!DOCTYPE html>
    <head lang="en">
        ...
        <title>Super Admin Payment</title>
...
<hr>
  ...
  <a href="SA_Payment.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25));margin-left:12px;margin-top:-5px;" class="w3-bar-item w3-button"><u><b>PAYMENT</u></b></a>
</div>
<!--Side bar-->
