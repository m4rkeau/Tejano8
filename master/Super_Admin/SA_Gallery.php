<!DOCTYPE html>
    <head lang="en">
        ...
        <title>Super Admin Gallery</title>
...
<body>
  ...
  <a href="SA_Gallery.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25)); margin-left:12px;margin-top:-5px;" class="w3-bar-item w3-button"><u><b>GALLERY</u></b></a>
<hr>
...
<div style="margin-left:14%">
  <div class="w3-container">
    <!--Dashboard Button-->
  <div class="dash"><a href="Super_Admin/SA_Dashboard.php" style="font-size:15px;" ><b>Dashboard</b></a></div>
