<!DOCTYPE html>
    <head lang="en">
        ...
        <title>Super Admin Scheduler</title>
...
<hr>
  ...
  <a href="SA_Sched.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25));margin-left:12px;margin-top:-15px;" class="w3-bar-item w3-button"><u><b>SCHEDULE</u></b></a>
<hr>
