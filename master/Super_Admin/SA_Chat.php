...
<body>
    ...
    <div class="sidelogo">
    <!--Side Logo-->
    <img src="Super_Admin/dashboard_img/side_logo.png" width="150"height="40">
        </div>
...
<hr>
  ...
  <a href="A_Staff.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25));margin-left:12px;margin-top:-10px;" class="w3-bar-item w3-button">STAFF</a>
...
<hr>
  ...
  <a href="SA_Chat.php" style="background-image: linear-gradient(to right, rgba(0,0,0,0.3), rgba(200,145,22,0.25));margin-left:12px;margin-top:-15px;" class="w3-bar-item w3-button"><b><u>CHAT LOGS</u></b></a>
  <hr>
...
<div style="margin-left:14%">
  <div class="w3-container">
    <!--Dashboard Button-->
  <div class="dash"><a href="Super_Admin/SA_Dashboard.php" style="font-size:15px;" >Dashboard</div>
