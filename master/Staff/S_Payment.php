    ...
    <head lang="en">
        ...
        <style>
            ...
            *{
            ...
            body{
                margin:0;
                background-image: url(S_img/payment.jpg);
                background-size: 100%;
        ...
        <div class="cont2">
            <h1>GCASH<br><b><u>09956501705</u></b></h1>
            <br><br><br><br><br><br><br><br>
            <h1>OR</h1><br><br><br>
            <h1 style="font-size:30px;">ONLINE BANK <br>TRANSFER<br><b>(METROBANK)<br>XXXX-XXXX-XXXX</b></br></h1>
        </div>

        
        <div class="b_container">
        
        <a href="#" class="button" id="button">UPLOAD PROOF OF PAYMENT (WHOLE/DOWNPAYMENT)</a>
        </div>
       <!--button to               ↓           open popup-->
        <div class="popup">
            <div class="popup-content">
            <img src="S_img/return.png" alt="Close" class="close"width="20" height="20" style="left">
            <!--file upload code-->
            </div>
