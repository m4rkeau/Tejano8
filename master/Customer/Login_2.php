...
<form method="post" action="Login Page/lc.php">
    <?php
    // Display error message if there is one in the session variable
    ...
    <a href="Login Page/For_Pass.php" style="float:left; margin-left:20px; opacity:0.8;">Forgot Password</a>
